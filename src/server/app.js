...
async.series([
    ...
    function(callback) {
        ...
        console.log('Port:        ' + config.server.localport);
        console.log('VCAPP Port:  ' + process.env.VCAP_APP_PORT);
        callback();
    },
    ...
    function(callback) {
        ...
        console.log("now webhooks['pull_request'] points to "+JSON.stringify(webhooks['pull_request']));
    }
], function(err) {
    if (err) {
